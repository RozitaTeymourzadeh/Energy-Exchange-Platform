...
*
 */
func PrepareHeartBeatData(sbc *SyncBlockChain, selfId int32, peerMapJson string, addr string, generateNewBlock bool, nonce string, mpt MerklePatriciaTrie, peerPublicKey *rsa.PublicKey, ifValidTransaction bool, transactionInfoJson string) HeartBeatData {
